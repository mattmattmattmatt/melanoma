...
researcher_id varchar(45), -- e.g. tb412
KEY id (id), 
PRIMARY KEY(id)
) ENGINE=InnoDB;
...
snv_score float(5,2),
clr_score float(5,2),
tumour_bases_and_counts varchar(100),
normal_bases_and_counts varchar(100),
read_allele_freq varchar(100),
dbsnp_allele_freq varchar(100),
read_depth int unsigned,
median_quality_score float(4,2),
aa_change varchar(10),
polyphen_prediction varchar(40),
polyphen_score float(2,2),
sift_prediction varchar(40),
sift_score float(2,2),
snv_exon_type ENUM('SYN','NON-SYN','SPLICE'),
...
CREATE TABLE snv_annotations (
id int unsigned AUTO_INCREMENT,
column_number int unsigned,
column_name varchar(40),
column_value varchar(10000),
snv_row_id int unsigned,
KEY id(id),
...
end_coord int unsigned,
var_type ENUM('DEL','INS'),
var_length int unsigned,
var_base varchar(1000),
var_score float(5,2),
clr_score float(5,2),
tumour_bases_and_counts varchar(100),
normal_bases_and_counts varchar(100),
